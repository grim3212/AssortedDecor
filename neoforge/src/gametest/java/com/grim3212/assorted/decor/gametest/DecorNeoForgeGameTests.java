 ...
 * {@code AssortedDecorNeoForge}: nothing in {@code main} may reference the gametest source set, or
...
public final class DecorNeoForgeGameTests {

    private DecorNeoForgeGameTests() {
    }

    @SubscribeEvent
    public static void registerGameTests(final RegisterEvent event) {
        event.register(Registries.TEST_FUNCTION, helper -> DecorGameTests.forEach(
