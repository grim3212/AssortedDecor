...
public class ColorizerBlockBakedModel extends ColorizerBaseBakedModel {
	...
	public ColorizerBlockBakedModel(BakedModel bakedColorizer, UnbakedModel unbakedModel, IGeometryBakingContext owner, TextureAtlasSprite baseSprite, ModelBaker bakery, Function<Material, TextureAtlasSprite> spriteGetter, ModelState transform, ItemOverrides overrides, ResourceLocation name) {
