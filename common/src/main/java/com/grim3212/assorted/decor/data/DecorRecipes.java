...
public class DecorRecipes extends ConditionalRecipeProvider {
    ...
    public void buildRecipes() {
        ...
        DecorItems.PAINT_ROLLER_COLORS.forEach((c, r) -> {
            ...
            ShapelessRecipeBuilder.shapeless(this.items, RecipeCategory.DECORATIONS, DyeHelper.CARPET_BY_DYE.get(c)).requires(r.get()).requires(LibCommonTags.Items.CARPET).unlockedBy("has_carpet", has(LibCommonTags.Items.CARPET)).save(this.output, key(name(DyeHelper.CARPET_BY_DYE.get(c).asItem()) + "_paint_roll"));
