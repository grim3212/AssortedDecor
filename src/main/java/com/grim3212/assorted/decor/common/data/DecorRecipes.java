...
public class DecorRecipes extends RecipeProvider implements IConditionBuilder {
	...
	public DecorRecipes(PackOutput output) {
		super(output);
	}

	@Override
	protected void buildRecipes(Consumer<FinishedRecipe> consumer) {
		ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, DecorBlocks.SIDEWALK.get(), 6).define('X', Tags.Items.STONE).pattern("XXX").pattern("XXX").unlockedBy("has_stone", has(Tags.Items.STONE)).save(consumer);
		ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, DecorItems.TARBALL.get(), 16).define('X', ItemTags.COALS).define('G', Tags.Items.GRAVEL).define('W', StoredFluidIngredient.of(null, FluidTags.WATER)).pattern("X").pattern("G").pattern("W").unlockedBy("has_coal", has(ItemTags.COALS)).save(consumer);
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, DecorBlocks.ROADWAY.get()).define('A', DecorItems.ASPHALT.get()).define('X', Tags.Items.STONE).pattern("A").pattern("X").unlockedBy("has_asphalt", has(DecorItems.ASPHALT.get())).save(consumer);
		ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, DecorBlocks.ROADWAY_MANHOLE.get()).define('M', Tags.Items.INGOTS_IRON).define('X', DecorBlocks.ROADWAY.get()).pattern("M").pattern("X").unlockedBy("has_roadway", has(DecorBlocks.ROADWAY.get())).save(consumer);
		ConditionalRecipe.builder().addCondition(not(tagEmpty(DecorTags.Items.INGOTS_STEEL))).addRecipe(ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, DecorBlocks.ROADWAY_MANHOLE.get()).define('M', DecorTags.Items.INGOTS_STEEL).define('X', DecorBlocks.ROADWAY.get()).pattern("M").pattern("X").unlockedBy("has_roadway", has(DecorBlocks.ROADWAY.get()))::save).generateAdvancement().build(consumer, prefix("steel_roadway_manhole"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, DecorItems.PAINT_ROLLER.get()).define('S', Tags.Items.RODS_WOODEN).define('W', ItemTags.WOOL).pattern("WWW").pattern(" S ").pattern(" S ").unlockedBy("has_wool", has(ItemTags.WOOL)).save(consumer);

		DecorItems.PAINT_ROLLER_COLORS.forEach((c, r) -> {
			ShapelessRecipeBuilder.shapeless(RecipeCategory.DECORATIONS, r.get()).requires(DecorItems.PAINT_ROLLER.get()).requires(DifferenceIngredient.of(Ingredient.of(c.getTag()), Ingredient.of(DecorTags.Items.PAINT_ROLLERS))).unlockedBy("has_dye", has(c.getTag())).save(consumer);
			ShapelessRecipeBuilder.shapeless(RecipeCategory.DECORATIONS, PaintRollerItem.WOOL_BY_DYE.get(c)).requires(r.get()).requires(ItemTags.WOOL).unlockedBy("has_wool", has(ItemTags.WOOL)).save(consumer, prefix(name(PaintRollerItem.WOOL_BY_DYE.get(c).asItem()) + "_paint_roll"));
			ShapelessRecipeBuilder.shapeless(RecipeCategory.DECORATIONS, PaintRollerItem.CONCRETE_BY_DYE.get(c)).requires(r.get()).requires(DecorTags.Items.CONCRETE).unlockedBy("has_concrete", has(DecorTags.Items.CONCRETE)).save(consumer, prefix(name(PaintRollerItem.CONCRETE_BY_DYE.get(c).asItem()) + "_paint_roll"));
			ShapelessRecipeBuilder.shapeless(RecipeCategory.DECORATIONS, PaintRollerItem.CONCRETE_POWDER_BY_DYE.get(c)).requires(r.get()).requires(DecorTags.Items.CONCRETE_POWDER).unlockedBy("has_concrete_powder", has(DecorTags.Items.CONCRETE_POWDER)).save(consumer, prefix(name(PaintRollerItem.CONCRETE_POWDER_BY_DYE.get(c).asItem()) + "_paint_roll"));
			ShapelessRecipeBuilder.shapeless(RecipeCategory.DECORATIONS, PaintRollerItem.CARPET_BY_DYE.get(c)).requires(r.get()).requires(DecorTags.Items.CARPET).unlockedBy("has_carpet", has(DecorTags.Items.CARPET)).save(consumer, prefix(name(PaintRollerItem.CARPET_BY_DYE.get(c).asItem()) + "_paint_roll"));
			...
			ShapelessItemStackBuilder.shapeless(ColorChangingBlock.getColorStack(new ItemStack(DecorBlocks.SIDING_VERTICAL.get(), 4), c), RecipeCategory.DECORATIONS).requires(DecorTags.Items.TAR).requires(Tags.Items.COBBLESTONE).requires(r.get()).unlockedBy("has_tar", has(DecorTags.Items.TAR)).save(consumer, prefix("siding_vertical_" + c.getName()));
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.DECORATIONS, DecorBlocks.ROADWAY.get()).requires(DecorTags.Items.ROADWAYS_COLOR).requires(StoredFluidIngredient.of(null, FluidTags.WATER)).unlockedBy("has_roadway_color", has(DecorTags.Items.ROADWAYS_COLOR)).save(consumer, prefix(DecorBlocks.ROADWAY.getId().getPath() + "_wash"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, DecorItems.IRON_FRAME.get()).define('X', Tags.Items.INGOTS_IRON).pattern("  X").pattern(" X ").pattern("X  ").unlockedBy("has_iron", has(Tags.Items.INGOTS_IRON)).save(consumer);
		ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, DecorItems.COLORIZER_BRUSH.get()).define('X', DecorBlocks.COLORIZER.get()).define('R', Tags.Items.RODS_WOODEN).define('S', Tags.Items.STRING).pattern(" SX").pattern(" RS").pattern("R  ").unlockedBy("has_colorizer", has(DecorBlocks.COLORIZER.get())).save(consumer);
		ShapelessRecipeBuilder.shapeless(RecipeCategory.DECORATIONS, DecorItems.COLORIZER_BRUSH.get()).requires(StoredFluidIngredient.of(null, FluidTags.WATER)).requires(DecorItems.COLORIZER_BRUSH.get()).unlockedBy("has_brush", has(DecorItems.COLORIZER_BRUSH.get())).save(consumer, prefix("clean_colorizer_brush"));
		ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, DecorItems.NEON_SIGN.get(), 3).define('X', Tags.Items.OBSIDIAN).define('G', ItemTags.PLANKS).define('C', Tags.Items.DUSTS_REDSTONE).pattern("XXX").pattern("XCX").pattern(" G ").unlockedBy("has_obsidian", has(Tags.Items.OBSIDIAN)).save(consumer);

		ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, DecorBlocks.COLORIZER.get(), 4).define('X', Tags.Items.STONE).define('R', Tags.Items.DYES_RED).define('G', Tags.Items.DYES_GREEN).define('B', Tags.Items.DYES_BLUE).define('D', Tags.Items.DYES).pattern("XRX").pattern("GDB").pattern("XDX").unlockedBy("has_stone", has(Tags.Items.STONE)).unlockedBy("has_dye", has(Tags.Items.DYES)).save(consumer);
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, DecorBlocks.COLORIZER_STOOL.get(), 4).define('X', DecorBlocks.COLORIZER.get()).define('S', Tags.Items.RODS_WOODEN).pattern("XXX").pattern("S S").unlockedBy("has_colorizer", has(DecorBlocks.COLORIZER.get())).save(consumer);
		ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, DecorBlocks.COLORIZER_COUNTER.get(), 4).define('X', DecorBlocks.COLORIZER.get()).define('S', Tags.Items.RODS_WOODEN).pattern("XXX").pattern(" S ").unlockedBy("has_colorizer", has(DecorBlocks.COLORIZER.get())).save(consumer);
		ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, DecorBlocks.COLORIZER_FENCE.get(), 4).define('X', DecorBlocks.COLORIZER.get()).define('S', Tags.Items.RODS_WOODEN).pattern("XSX").pattern("XSX").unlockedBy("has_colorizer", has(DecorBlocks.COLORIZER.get())).save(consumer);
		ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, DecorBlocks.COLORIZER_FENCE_GATE.get(), 2).define('X', DecorBlocks.COLORIZER.get()).define('S', Tags.Items.RODS_WOODEN).pattern("SXS").pattern("SXS").unlockedBy("has_colorizer", has(DecorBlocks.COLORIZER.get())).save(consumer);
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, DecorBlocks.COLORIZER_CHIMNEY.get(), 6).define('X', DecorBlocks.COLORIZER.get()).define('I', Tags.Items.INGOTS_IRON).pattern("X X").pattern("X X").pattern("XIX").unlockedBy("has_colorizer", has(DecorBlocks.COLORIZER.get())).unlockedBy("has_iron", has(Tags.Items.INGOTS_IRON)).save(consumer);
		...
		ConditionalRecipe.builder().addCondition(not(tagEmpty(DecorTags.Items.INGOTS_ALUMINUM))).addRecipe(ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, DecorBlocks.ILLUMINATION_TUBE.get(), 4).define('G', Tags.Items.GLASS).define('L', Tags.Items.DUSTS_GLOWSTONE).define('A', DecorTags.Items.INGOTS_ALUMINUM).pattern(" A ").pattern("GLG").pattern(" A ").unlockedBy("has_aluminum", has(DecorTags.Items.INGOTS_ALUMINUM)).unlockedBy("has_glowstone", has(Tags.Items.DUSTS_GLOWSTONE))::save)
				.generateAdvancement().build(consumer, DecorBlocks.ILLUMINATION_TUBE.getId());
		ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, DecorBlocks.ILLUMINATION_TUBE.get(), 4).define('G', Tags.Items.GLASS).define('L', Tags.Items.DUSTS_GLOWSTONE).define('A', Tags.Items.INGOTS_IRON).pattern(" A ").pattern("GLG").pattern(" A ").unlockedBy("has_aluminum", has(Tags.Items.INGOTS_IRON)).unlockedBy("has_glowstone", has(Tags.Items.DUSTS_GLOWSTONE)).save(consumer, prefix("illumination_tube_iron"));

		ConditionalRecipe.builder().addCondition(not(tagEmpty(DecorTags.Items.INGOTS_ALUMINUM)))
				.addRecipe(ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, DecorBlocks.ILLUMINATION_PLATE.get(), 8).define('G', Tags.Items.GLASS_PANES).define('L', DecorBlocks.ILLUMINATION_TUBE.get()).define('A', DecorTags.Items.INGOTS_ALUMINUM).pattern("GGG").pattern("ALA").pattern("GGG").unlockedBy("has_aluminum", has(DecorTags.Items.INGOTS_ALUMINUM)).unlockedBy("has_glowstone", has(Tags.Items.DUSTS_GLOWSTONE))::save).generateAdvancement()
				.build(consumer, DecorBlocks.ILLUMINATION_PLATE.getId());
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, DecorBlocks.BONE_DECORATION.get()).define('X', Tags.Items.BONES).pattern(" X ").pattern("XXX").pattern("XXX").unlockedBy("has_bones", has(Tags.Items.BONES)).save(consumer);
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, DecorBlocks.BONE_LANTERN.get()).define('P', Tags.Items.BONES).define('C', DecorTags.Items.LANTERN_SOURCE).pattern(" P ").pattern("PCP").unlockedBy("has_lantern_input", has(DecorTags.Items.LANTERN_SOURCE)).save(consumer);
		ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, DecorBlocks.IRON_LANTERN.get()).define('P', Tags.Items.INGOTS_IRON).define('C', DecorTags.Items.LANTERN_SOURCE).pattern(" P ").pattern("PCP").unlockedBy("has_lantern_input", has(DecorTags.Items.LANTERN_SOURCE)).save(consumer);
		...
		FluroBlock.FLURO_BY_DYE.entrySet().stream().forEach((x) -> {
			...
			ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, b, 4).define('G', Tags.Items.GLASS).define('L', DecorBlocks.ILLUMINATION_TUBE.get()).define('A', b.getColor().getTag()).pattern("GAG").pattern("ALA").pattern("GAG").unlockedBy("has_dye", has(Tags.Items.DYES)).unlockedBy("has_tube", has(DecorBlocks.ILLUMINATION_TUBE.get())).save(consumer);
		});

		ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, DecorItems.CHAIN_LINK.get(), 4).define('X', Tags.Items.INGOTS_IRON).define('N', Tags.Items.NUGGETS_IRON).pattern(" N ").pattern("NXN").pattern(" N ").unlockedBy("has_ingot", has(Tags.Items.INGOTS_IRON)).save(consumer);
		ConditionalRecipe.builder().addCondition(not(tagEmpty(DecorTags.Items.INGOTS_STEEL))).addRecipe(ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, DecorItems.CHAIN_LINK.get(), 4).define('X', DecorTags.Items.INGOTS_STEEL).define('N', DecorTags.Items.NUGGETS_STEEL).pattern(" N ").pattern("NXN").pattern(" N ").unlockedBy("has_ingot", has(DecorTags.Items.INGOTS_STEEL))::save).generateAdvancement().build(consumer, prefix("chain_link_steel"));
		ConditionalRecipe.builder().addCondition(not(tagEmpty(DecorTags.Items.INGOTS_ALUMINUM))).addRecipe(ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, DecorItems.CHAIN_LINK.get(), 4).define('X', DecorTags.Items.INGOTS_ALUMINUM).define('N', DecorTags.Items.NUGGETS_ALUMINUM).pattern(" N ").pattern("NXN").pattern(" N ").unlockedBy("has_ingot", has(DecorTags.Items.INGOTS_ALUMINUM))::save).generateAdvancement().build(consumer, prefix("chain_link_aluminum"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, DecorBlocks.GLASS_DOOR.get(), 3).define('X', Tags.Items.GLASS).pattern("XX").pattern("XX").pattern("XX").unlockedBy("has_glass", has(Tags.Items.GLASS)).save(consumer);
		ConditionalRecipe.builder().addCondition(not(tagEmpty(DecorTags.Items.INGOTS_STEEL))).addRecipe(ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, DecorBlocks.STEEL_DOOR.get(), 3).define('X', DecorTags.Items.INGOTS_STEEL).pattern("XX").pattern("XX").pattern("XX").unlockedBy("has_steel", has(DecorTags.Items.INGOTS_STEEL))::save).generateAdvancement().build(consumer, DecorBlocks.STEEL_DOOR.getId());
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, DecorBlocks.FOUNTAIN.get()).define('X', Tags.Items.COBBLESTONE).define('W', StoredFluidIngredient.of(null, FluidTags.WATER)).define('I', DecorTags.Items.INGOTS_ALUMINUM).pattern("XIX").pattern("XWX").pattern("XIX").unlockedBy("has_ingot", has(DecorTags.Items.INGOTS_ALUMINUM)).save(consumer, prefix("fountain_aluminum"));
		ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, DecorBlocks.FOUNTAIN.get()).define('X', Tags.Items.COBBLESTONE).define('W', StoredFluidIngredient.of(null, FluidTags.WATER)).define('I', DecorTags.Items.INGOTS_STEEL).pattern("XIX").pattern("XWX").pattern("XIX").unlockedBy("has_ingot", has(DecorTags.Items.INGOTS_STEEL)).save(consumer, prefix("fountain_steel"));
		ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, DecorBlocks.FOUNTAIN.get()).define('X', Tags.Items.COBBLESTONE).define('W', StoredFluidIngredient.of(null, FluidTags.WATER)).define('I', Tags.Items.INGOTS_IRON).pattern("XIX").pattern("XWX").pattern("XIX").unlockedBy("has_ingot", has(Tags.Items.INGOTS_IRON)).save(consumer);
