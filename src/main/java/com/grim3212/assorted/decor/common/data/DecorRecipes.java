...
public class DecorRecipes extends RecipeProvider {
	...
	protected void buildShapelessRecipes(Consumer<IFinishedRecipe> consumer) {
		...
		CookingRecipeBuilder.smelting(Ingredient.of(DecorItems.UNFIRED_PLANTER_POT.get()), DecorBlocks.PLANTER_POT.get(), 0.35f, 200).unlockedBy("has_unfired_planter_pot", has(DecorItems.UNFIRED_PLANTER_POT.get())).save(consumer);

		SingleItemRecipeBuilder.stonecutting(Ingredient.of(DecorBlocks.COLORIZER.get()), DecorBlocks.COLORIZER_SLAB.get(), 2).unlocks("has_colorizer", has(DecorBlocks.COLORIZER.get())).save(consumer, prefix("colorizer_slab_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(DecorBlocks.COLORIZER.get()), DecorBlocks.COLORIZER_VERTICAL_SLAB.get(), 2).unlocks("has_colorizer", has(DecorBlocks.COLORIZER.get())).save(consumer, prefix("colorizer_vertical_slab_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(DecorBlocks.COLORIZER.get()), DecorBlocks.COLORIZER_STAIRS.get()).unlocks("has_colorizer", has(DecorBlocks.COLORIZER.get())).save(consumer, prefix("colorizer_stairs_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(DecorBlocks.COLORIZER.get()), DecorBlocks.COLORIZER_WALL.get()).unlocks("has_colorizer", has(DecorBlocks.COLORIZER.get())).save(consumer, prefix("colorizer_walls_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(DecorBlocks.COLORIZER.get()), DecorBlocks.COLORIZER_CHAIR.get()).unlocks("has_colorizer", has(DecorBlocks.COLORIZER.get())).save(consumer, prefix("colorizer_chair_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(DecorBlocks.COLORIZER.get()), DecorBlocks.COLORIZER_TABLE.get()).unlocks("has_colorizer", has(DecorBlocks.COLORIZER.get())).save(consumer, prefix("colorizer_table_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(DecorBlocks.COLORIZER.get()), DecorBlocks.COLORIZER_SLOPE.get()).unlocks("has_colorizer", has(DecorBlocks.COLORIZER.get())).save(consumer, prefix("colorizer_slope_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(DecorBlocks.COLORIZER.get()), DecorBlocks.COLORIZER_SLOPED_ANGLE.get()).unlocks("has_colorizer", has(DecorBlocks.COLORIZER.get())).save(consumer, prefix("colorizer_sloped_angle_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(DecorBlocks.COLORIZER.get()), DecorBlocks.COLORIZER_SLOPED_INTERSECTION.get()).unlocks("has_colorizer", has(DecorBlocks.COLORIZER.get())).save(consumer, prefix("colorizer_sloped_intersection_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(DecorBlocks.COLORIZER.get()), DecorBlocks.COLORIZER_SLOPED_POST.get()).unlocks("has_colorizer", has(DecorBlocks.COLORIZER.get())).save(consumer, prefix("colorizer_sloped_post_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(DecorBlocks.COLORIZER.get()), DecorBlocks.COLORIZER_OBLIQUE_SLOPE.get()).unlocks("has_colorizer", has(DecorBlocks.COLORIZER.get())).save(consumer, prefix("colorizer_oblique_slope_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(DecorBlocks.COLORIZER.get()), DecorBlocks.COLORIZER_CORNER.get()).unlocks("has_colorizer", has(DecorBlocks.COLORIZER.get())).save(consumer, prefix("colorizer_corner_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(DecorBlocks.COLORIZER.get()), DecorBlocks.COLORIZER_SLANTED_CORNER.get()).unlocks("has_colorizer", has(DecorBlocks.COLORIZER.get())).save(consumer, prefix("colorizer_slanted_corner_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(DecorBlocks.COLORIZER.get()), DecorBlocks.COLORIZER_PYRAMID.get()).unlocks("has_colorizer", has(DecorBlocks.COLORIZER.get())).save(consumer, prefix("colorizer_pyramid_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(DecorBlocks.COLORIZER.get()), DecorBlocks.COLORIZER_FULL_PYRAMID.get()).unlocks("has_colorizer", has(DecorBlocks.COLORIZER.get())).save(consumer, prefix("colorizer_full_pyramid_stonecutting"));
